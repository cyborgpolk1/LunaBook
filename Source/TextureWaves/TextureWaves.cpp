...
TextureWavesApp::~TextureWavesApp()
{
	ReleaseCOM(mLandVB);
	ReleaseCOM(mLandIB);
	ReleaseCOM(mWavesVB);
...
void TextureWavesApp::UpdateScene(float dt)
{
...
void TextureWavesApp::DrawScene()
{
...
void TextureWavesApp::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void TextureWavesApp::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void TextureWavesApp::OnMouseMove(WPARAM btnState, int x, int y)
{
...
float TextureWavesApp::GetHeight(float x, float z) const
{
	return 0.3f * (z * sinf(0.1f * x) + x * cosf(0.1f * z));
}

XMFLOAT3 TextureWavesApp::GetHillNormal(float x, float z) const
{
	// n = (-df/dx, 1, -df/dz)
	XMFLOAT3 n(
...
void TextureWavesApp::BuildLandGeometryBuffers()
{
...
void TextureWavesApp::BuildWavesGeometryBuffers()
{
