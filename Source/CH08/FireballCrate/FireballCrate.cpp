...
void CrateApp::BuildFX()
{
	...
	CreateShader(&mVS, ExePath().append(L"../../../Shaders/Multitexture.hlsl").c_str(), "VS", 0, &mInputLayout, vertexDesc, 2);
	CreateShader(&mPS, ExePath().append(L"../../../Shaders/Multitexture.hlsl").c_str(), "PS", 0);
