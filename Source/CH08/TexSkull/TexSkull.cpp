...
void TexSkullDemo::UpdateScene(float dt)
{
...
void TexSkullDemo::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void TexSkullDemo::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void TexSkullDemo::OnMouseMove(WPARAM btnState, int x, int y)
{
