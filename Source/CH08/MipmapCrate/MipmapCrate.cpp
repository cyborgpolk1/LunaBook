...
void CrateApp::OnMouseMove(WPARAM btnState, int x, int y)
{
	...
	else if ((btnState & MK_RBUTTON) != 0)
	{
		...
		// Restrict the radius.
		mRadius = MathHelper::Clamp(mRadius, 3.0f, 60.0f);
	}
...
void CrateApp::BuildTex()
{
	...
	HR(CreateDDSTextureFromFile(md3dDevice, ExePath().append(L"../../../Textures/mipmaps.dds").c_str(), &textureResource, &mTexture));
