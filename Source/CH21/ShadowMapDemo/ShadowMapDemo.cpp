...
void ShadowMapDemo::OnMouseDown(WPARAM btnState, int x, int y)
{
	mLastMousePos.x = x;
	mLastMousePos.y = y;
...
void ShadowMapDemo::OnMouseUp(WPARAM btnState, int x, int y)
{
	ReleaseCapture();
}

void ShadowMapDemo::OnMouseMove(WPARAM btnState, int x, int y)
{
...
void ShadowMapDemo::BuildShapeGeometryBuffer()
{
...
void ShadowMapDemo::BuildSkullGeometryBuffer()
{
	// Load skull
...
void ShadowMapDemo::BuildShadowTransform()
{
...
void ShadowMapDemo::DrawSceneToShadowMap()
{
...
void ShadowMapDemo::BuildScreenQuadGeometryBuffer()
{
...
void ShadowMapDemo::DrawScreenQuad()
{
