...
BoxApp::BoxApp(HINSTANCE hInstance)
	: D3DApp(hInstance), mBoxVB(), mBoxIB(0), mInputLayout(0), mVS(0), mPS(0), mMatrixBuffer(0),
...
void BoxApp::BuildFX()
{
	...
	ShaderHelper::CreateShader(md3dDevice, &mVS, ExePath().append(L"../../../Shaders/flubberCubeVS.hlsl").c_str(), "main", 0, &mInputLayout, vertexDesc, 2);
